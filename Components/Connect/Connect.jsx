  ...
  return (
    ...
    <div className="w-1/3 bg-white border border-gray-100 rounded-lg text-center hover:shadow-lg align-center">
        ...
        <div className="flex justify-center">
          <img src="https://picsum.photos/50/50" className="rounded-full object-center border-4 border-white -mt-6 shadow-lg align-center" />
        </div>
        <p className="font-bold pt-3 pb-2"> Mohammed Said </p>
        <p className="font-semibold p-2 text-sm text-gray-500"> by 
